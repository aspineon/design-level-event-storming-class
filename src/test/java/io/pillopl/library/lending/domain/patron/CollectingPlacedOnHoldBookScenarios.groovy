...
import static io.pillopl.library.lending.domain.patron.CollectDuration.forOneMonth
import static io.pillopl.library.lending.domain.patron.Fixtures.aRegularPatron
